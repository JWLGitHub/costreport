...
/**
 * Created by jwleader on 12/9/15.
 */
public class SetApplicationErrorSeqNum extends BaseValidator
{
    private static String CLASS_NAME  = SetApplicationErrorSeqNum.class.getName();
    private static String SIMPLE_NAME = SetApplicationErrorSeqNum.class.getSimpleName();
                                   ...
                                   throws Exception
    {
        ...
        fileContext.setApplErrSeqNum(0);
